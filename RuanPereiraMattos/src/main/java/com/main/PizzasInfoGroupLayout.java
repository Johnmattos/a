...
public class PizzasInfoGroupLayout extends GroupLayout {
    ...
    private void imprimir() {
        ...
        paper.setImageableArea(5, 0, (pageFormat.getWidth() - pageFormat.getImageableX()),
                (pageFormat.getHeight() - pageFormat.getImageableY()));
        ...
        printerJob.setPrintable((g, pf, pageIndex) -> {
            ...
            int interline = 15;
            y += interline;
            g.drawString("Nome: Ruan Pereira Mattos", x, y);
            y += interline;
            ...
            for (PizzaData pdt : arrayPizzaData) {
                ...
                if (!pdt.getBorda().equals("Sem Borda")) {
                    y += interline;
                    g.drawString("Borda: " + pdt.getBorda(), x + 10, y);
                }
                System.out.println("Tamanho: " + pdt.getTamanho());
                System.out.println("Borda: " + pdt.getBorda());
                System.out.println("Sabores: " + pdt.getSabores());
        ...
        if (printerJob.printDialog()) {
            try {
                ...
                Logger.getLogger(PizzasInfoGroupLayout.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
